...
export function ResponseSidebar({
  ...
  return (
    <aside className="flex min-h-0 flex-col border-r bg-surface" aria-label="Response navigation">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-2" role="listbox" aria-label="Responses">
        {responses.length ? (
          responses.map((response, index) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "mb-1 flex w-full items-start gap-3 rounded-xl px-3 py-3 text-left transition-colors [content-visibility:auto] [contain-intrinsic-size:60px]",
